                ...
                <div>
                  <div className="space-y-6">
                    <div className="text-secondary text-xl">
                      <p className="pb-10">
                        This project aims to transform &quot;MEGAWEAVING&quot;,
                        a resource-sharing initiative that began as a Facebook
                        group and now has over 10,000 members, into a
                        searchable, database-driven online platform that
                        connects idle or free resources globally and facilitates
                        transparent circulation and usage of these resources
                      ...
                      <p>
                        ...
                        sharing, promoting environmental sustainability and
                        social equity, especially assisting those who cannot
                        obtain basic resources due to economic conditions.
                      </p>
                    </div>
                  </div>
                </div>
